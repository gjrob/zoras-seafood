...
const ACCENT = '#ff3333'
const BUSINESS_NAME = 'Pop Car Auto Center'
...
export default function ChatBot() {
  ...
  const [messages, setMessages] = useState<Message[]>([
    { role: 'assistant', content: `Hi! I'm the ${BUSINESS_NAME} assistant. Ask me about services, pricing, hours, or how to book!` }
  ])
  ...
  async function send() {
    ...
    try {
      ...
      setMessages(prev => [...prev, { role: 'assistant', content: 'Something went wrong. Call us at (910) 834-3607!' }])
    }
    setLoading(false)
  }
      ...
      {open && (
        <div style={{
          ...
          <div style={{
            ...
            letterSpacing: '.08em', display: 'flex', justifyContent: 'space-between',
          }}>
            <span>🔧 {BUSINESS_NAME}</span>
            <span style={{ opacity: .6, fontSize: '11px', fontWeight: 400 }}>AI ASSISTANT</span>
          </div>
          ...
          <div style={{ display: 'flex', borderTop: '1px solid #222' }}>
            <input
              ...
              style={{
                ...
                color: '#f5f5f5', fontFamily: 'inherit', fontSize: '13px',
                padding: '12px 14px',
              }}
            />
            <button
              ...
              style={{
                background: loading || !input.trim() ? '#1a1a1a' : ACCENT,
                color: '#fff', border: 'none', cursor: 'pointer',
