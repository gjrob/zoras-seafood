...
export default function ChatBot() {
  ...
  const [messages, setMessages] = useState<Message[]>([{
    role: 'assistant',
    content: "Hey! I'm Max 🔧 — your guide to Pop Car Auto Center. Ask me about our services, hours, pricing, or anything else. ¿Hablas español? ¡También te atiendo!",
  }])
  ...
  const send = async () => {
    ...
    try {
      ...
      setLoading(false)
      setMessages(prev => [...prev, { role: 'assistant', content: "Having trouble connecting. Give us a call at (910) 834-3607 — we'll help!" }])
    }
  }
  ...
  return (
    <>
      <button
        ...
        aria-label={open ? 'Close chat' : 'Chat with Max'}
      >
        {open ? '✕' : '🔧'}
      </button>
